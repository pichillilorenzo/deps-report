...
function findDependents(globs/*: Array<string>*/, options/*: {root: string, parent: {excludeNodeModules: boolean, json: boolean, pretty: boolean, absPath: boolean, webpackConfig: string, specifiers: boolean} }*/)/*: Object*/{
