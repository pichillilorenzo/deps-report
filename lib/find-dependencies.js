...
function findDependencies(globs/*: Array<string>*/, options/*: {parent: {excludeNodeModules: boolean, json: boolean, pretty: boolean, absPath: boolean, webpackConfig: string, specifiers: boolean} }*/)/*: Object*/{
  ...
  for (let inputFile of inputFiles) {
    ...
    for (let imp /*: Object*/ of imports) {
      ...
      if (dependency.importPath) {
        ...
        else if ((dependency.importAbsolutePath.indexOf("node_modules") >= 0 || !fs.existsSync(dependency.importAbsolutePath)) && !options.parent.excludeNodeModules) {
