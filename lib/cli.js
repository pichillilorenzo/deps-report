        ...
        if (!result[entry].files) 
          ...
          for (let dependency of result[entry].dependencies) 
            console.log( 
              ...
              ( (options.circular && dependency.isCircularDependency) ? ', ' + colors.yellow.bold('Circular Dependency') : '' ) +
        ...
        if (!result[entry].files) 
          ...
          for (let dependent of result[entry].dependents)
            console.log( 
              ...
              ( (options.circular && dependent.isCircularDependency) ? ', ' + colors.yellow.bold('Circular Dependency') : '' ) +
