...
test('Test find-dependencies in project-test folder', t => {
  ...
  let optionsFindDependencies = {parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: false} }
  t.deepEqual(findDependencies(["tests/project-test/a.js"], optionsFindDependencies), testResults[0])

  optionsFindDependencies = {parent: {excludeNodeModules: true, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: false} }
  t.deepEqual(findDependencies(["tests/project-test/a.js"], optionsFindDependencies), testResults[1])

  optionsFindDependencies = {parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: false} }
...
test('Test find-dependents in project-test folder', t => {
  ...
  let optionsFindDependents = {root: '', parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: false} }
  ...
  optionsFindDependents = {root: 'tests/project-test', parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: false} }
  ...
  optionsFindDependents = {root: 'tests/project-test', parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack2.config.js', specifiers: false} }
...
test('Test find-dependencies in project-react-js-test folder', t => {
  ...
  let optionsFindDependencies = {parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: '', specifiers: false} }
  ...
  optionsFindDependencies = {parent: {excludeNodeModules: true, json: false, pretty: false, absPath: false, webpackConfig: '', specifiers: false} }
...
test('Test find-dependents in project-react-js-test folder', t => {
  ...
  let optionsFindDependents = {root: '', parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: '', specifiers: false} }
