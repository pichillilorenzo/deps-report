...
test('Test find-dependencies in project-test folder', t => {
  ...
  let optionsFindDependencies = {parent: {excludeNodeModules: false, json: true, pretty: false, absPath: false} }
  t.deepEqual(findDependencies("tests/project-test/a.js", optionsFindDependencies), ["fs", "./c/d.js", "fs", "./e/b.js", "./c/d.js"])

  optionsFindDependencies = {parent: {excludeNodeModules: true, json: true, pretty: false, absPath: false} }
  t.deepEqual(findDependencies("tests/project-test/a.js", optionsFindDependencies), ["./c/d.js", "./e/b.js", "./c/d.js"])

  optionsFindDependencies = {parent: {excludeNodeModules: false, json: true, pretty: false, absPath: false} }
...
test('Test find-dependents in project-test folder', t => {
  ...
  let optionsFindDependents = {root: '', parent: {excludeNodeModules: false, json: true, pretty: false, absPath: false} }
  ...
  optionsFindDependents = {root: 'tests/project-test', parent: {excludeNodeModules: false, json: true, pretty: false, absPath: false} }
