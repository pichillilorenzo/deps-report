...
test('Test find-dependencies in project-test folder', t => {
  ...
  let optionsFindDependencies = {circular: false, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  ...
  optionsFindDependencies = {circular: false, onlyCircular: false, parent: {excludeNodeModules: true, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  ...
  optionsFindDependencies = {circular: true, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  ...
  optionsFindDependencies = {circular: true, onlyCircular: true, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  ...
  optionsFindDependencies = {circular: false, onlyCircular: false, parent: {excludeNodeModules: true, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  t.deepEqual(findDependencies(["tests/project-test/b.ts"], optionsFindDependencies), testResults[4])
...
test('Test find-dependents in project-test folder', t => {
  ...
  let optionsFindDependents = {root: '', circular: false, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  t.deepEqual(findDependents(["tests/project-test/b.ts"], optionsFindDependents), testResults[5])
  ...
  t.deepEqual(findDependents(["tests/project-test/a.js"], optionsFindDependents), testResults[6])
  ...
  optionsFindDependents = {root: 'tests/project-test', circular: false, onlyCircular: true, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  t.deepEqual(findDependents(["tests/project-test/c/d.js"], optionsFindDependents), testResults[7])
  ...
  optionsFindDependents = {root: 'tests/project-test', circular: true, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  ...
  optionsFindDependents = {root: 'tests/project-test', circular: false, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack.config.js', specifiers: true, color: false} }
  t.deepEqual(findDependents(["tests/project-test/src/templates/*.js", "tests/project-test/src/utilities/*.js"], optionsFindDependents), testResults[9])
  ...
  optionsFindDependents = {root: 'tests/project-test', circular: false, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: 'tests/project-test/webpack2.config.js', specifiers: true, color: false} }
  t.deepEqual(findDependents(["tests/project-test/src/templates/*.js", "tests/project-test/src/utilities/*.js"], optionsFindDependents), testResults[9])
})
...
test('Test find-dependencies in project-react-js-test folder', t => {
  ...
  let optionsFindDependencies = {circular: true, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: '', specifiers: true, color: false} }
  t.deepEqual(findDependencies(["tests/project-react-js-test/src/*.js", "!tests/project-react-js-test/src/*.test.js"], optionsFindDependencies), testResults[10])
  ...
  optionsFindDependencies = {circular: false, onlyCircular: false, parent: {excludeNodeModules: true, json: false, pretty: false, absPath: false, webpackConfig: '', specifiers: true, color: false} }
  t.deepEqual(findDependencies(["tests/project-react-js-test/src/*.js"], optionsFindDependencies), testResults[11])
...
test('Test find-dependents in project-react-js-test folder', t => {
  ...
  let optionsFindDependents = {root: '', circular: false, onlyCircular: false, parent: {excludeNodeModules: false, json: false, pretty: false, absPath: false, webpackConfig: '', specifiers: true, color: false} }
  t.deepEqual(findDependents(["tests/project-react-js-test/src/*.js"], optionsFindDependents), testResults[12])
